...
<body >
<input id="savesuccess" style="display : none" value="${upsusorfail}">
<div>
	<h1 >请填写完整所有信息:</h1>
</div>
<div>
     <form  class="form-horizontal" id="formadd" name="formadd" method="post" action="<%=path %>/studentinfo/updatestudentinfo">
	   <input  id="studentCardid" name="studentCardid" class="form-control" type="text" style="display: none" value="${student.studentCardid} " />
	   <div class="form-group">
	    <label class="col-sm-2 control-label" for="enrollmentYear">入学年份:</label>
	  	
	   <div class="col-sm-3"> 
	        <div class="input-append date" id="datetimepicker" data-date="12-02-2012" data-date-format="dd-mm-yyyy">
        <input id="enrollmentYear" name="enrollmentYear" class="form-control span2  form_datetime" type="text" value="${student.enrollmentYear}" />
   		 </div>            
	    </div>
	    <label class="col-sm-2 control-label" for="studentName">学生姓名:</label>
	     <div class="col-sm-3">
	    <input id="studentName" name="studentName" class="form-control" type="text" value="${student.studentName} " />
		</div>
		</div>
		<div class="form-group">
	    ...
	    <label class="col-sm-2 control-label" for="birthday" >出生日期:</label>
	     <div class="col-sm-3">
	    <input id="birthday" name="birthday" class="form-control form_datetime" type="text" value="${student.birthday}" />
	    </div>
	   </div>
	   <div class="form-group">
	    <label class="col-sm-2 control-label" for="nativePlace">籍贯:</label>
	     <div class="col-sm-3">
	    <input id="nativePlace" name="nativePlace" class="form-control" type="text" value="${student.nativePlace}" />
	   </div>
	    <label class="col-sm-2 control-label" for="academy">学院名:</label>
	     <div class="col-sm-3">
	    <input id="academy" name="academy" class="form-control" type="text" value="${student.academy}" />
	    </div></div>
	   <div class="form-group">
	    <label class="col-sm-2 control-label" for="specialty">专业:</label>
	     <div class="col-sm-3">
	    <input id="specialty" name="specialty" class="form-control" type="text" value="${student.specialty}" />
	    </div>
	    <label class="col-sm-2 control-label" for="classname">班级:</label>
	     <div class="col-sm-3">
	    <input id="classname" name="classname" class="form-control" type="text"  value="${student.classname}"/>
	    </div>
	    </div>
	      <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div id="modalbodytext" class="modal-body " style="font-size: 20px">添加成功</div>
 ...
 $(document).ready(function () {
	 ...
	 $("#sexid").val('${student.sexid}');
	 var savesuc=$("#savesuccess").val();
	 if(savesuc=='1'){
		 $("#modalbodytext").empty();
		 $("#modalbodytext").text("更新成功");
		 $("#myModal").modal('show');
	 }else if(savesuc=='0'){
		 $("#modalbodytext").empty();
		 $("#modalbodytext").text("更新失败");
		 $("#myModal").modal('show');
	 }
	 $("#savesuccess").val("2");
 }); 
