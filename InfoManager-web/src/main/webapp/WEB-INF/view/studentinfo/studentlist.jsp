...
<div>
     <form  class="form-horizontal" id="formadd" name="formadd" method="post" action="<%=path %>/studentinfo/tostudentlist/1">
	   ...
	   <div class="form-group">
	    <label class="col-sm-2 control-label" for="studentStatus">学生状态:</label>
	     <div class="col-sm-2">
	    <input id="studentStatus" name="studentStatus" class="form-control" type="text"  value="${status }" onclick="JavaScript:this.value=''"/>
	   </div>
...
<table class="table table-hover">
  ...
  <tbody>
   	<c:forEach items="${studentList}" var="student" >
   		<tr>
   			<td><a href="<%=path %>/studentinfo/toupdatestudent/${student.studentCardid}">${student.studentCardid}</a></td>
	...
	<ul class="pager">
  	...
  	<input id="status" style="display:none" value="${status} ">
